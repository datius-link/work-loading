...
import { ActivityIndicator, Image, Modal, Pressable, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, View, Linking } from "react-native";
...
function avatarFor(profile) {
  ...
  return `https://ui-avatars.com/api/?name=${encodeURIComponent(profile?.username || profile?.email || "U")}&background=0B6B63&color=fff&bold=true&rounded=true`;
}
...
const createStyles = (theme) => StyleSheet.create({
  ...
  topBar: { minHeight: 54, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottomWidth: 1, borderBottomColor: theme.colors.border, backgroundColor: theme.colors.bg }, iconBtn: { width: 40, height: 40, borderRadius: theme.radius.xs, alignItems: "center", justifyContent: "center" }, navTitle: { color: theme.colors.text, fontSize: 18, fontWeight: "900" }, navActions: { flexDirection: "row", alignItems: "center" },
