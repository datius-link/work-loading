...
const createStyles = (theme) => StyleSheet.create({
  ...
  statsRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 18, paddingVertical: 14, borderTopWidth: 1, borderBottomWidth: 1, borderColor: theme.colors.border }, statBlock: { flex: 1, alignItems: "center" }, statValue: { color: theme.colors.text, fontSize: 28, fontWeight: "900" }, statLabel: { color: theme.colors.textMuted, fontSize: 12.5, fontWeight: "800", marginTop: 3 },
