...
const SECTIONS = [
  ["What e-kazi collects", "Tunachokusanya", "We collect account, profile, job, message, rating, recommendation, and app activity data needed to operate e-kazi.", "Tunakusanya taarifa za akaunti, profaili, kazi, ujumbe, ratings, mapendekezo na matumizi ya app zinazohitajika kuendesha e-kazi."],
