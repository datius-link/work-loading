...
export default function AboutEkazi({ onBack, version = "1.0.0" }) {
  ...
  return (
    <SettingsScreen titleEn="About e-kazi" titleSw="Kuhusu e-kazi" onBack={onBack}>
      <View style={styles.logo}><Txt en="e-kazi" sw="e-kazi" style={styles.logoText} /></View>
      <Txt
...
const createStyles = (theme) =>
  StyleSheet.create({
    logo: { width: 72, height: 72, borderRadius: 18, backgroundColor: theme.colors.primary, alignItems: "center", justifyContent: "center", alignSelf: "center", marginVertical: 8 },
    logoText: { color: theme.colors.onPrimary, fontSize: 18, fontWeight: "900" },
